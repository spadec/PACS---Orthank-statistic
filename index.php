  ...
  <?php endif; ?>
    ...
    <div class="card mb-3">
      <div class="card-header">
        ...
        <?php echo $lng->MO; ?>: <?php if($studyes) {echo $db->getStudies($studyes[0])->MainDicomTags->InstitutionName; }?></div>
      <div class="card-body">
          ...
          <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
            ...
            <tbody>
                ...
                <tr>
                  ...
                  <th><a href="<?php echo $db->getViewLink("study",$study->ID); ?>">Просмотр</a></th>
                </tr>
